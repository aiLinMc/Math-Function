package com.ailinmc.function_math;
...
public class FunctionMathMod {
	...
	public static final String MODID = "function_math";

	public FunctionMathMod(IEventBus modEventBus) {
